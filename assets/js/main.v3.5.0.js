(() => {
  ...
  const translations = {
    en: {
      announcement: 'Registration is closed. The Opening Day and Training Days 1-7 are complete — Training Day 7 molecular dynamics materials, practical links, and photos are now available.',
      ...
      heroLead: 'The Computational Biophysics Workshop is underway. The Opening Day and Training Days 1-7 are complete. Training Day 7 on 19 August covered molecular dynamics foundations, force fields, simulation time steps, GROMACS setup, and CHARMM-GUI system preparation, and its learning materials are now available.',
      secureSeat: 'Record your attendance', exploreProgram: 'Open Day 7 materials', month: 'Events complete', daysWeek: 'Days / week', coreModules: 'Program modules', presenters: 'Presenters',
      ...
      videoText: 'Watch this short introduction to the workshop identity, scientific scope, and hands-on learning experience. Training Day 7 is now complete.',
      ...
      dayOneEyebrow: 'Workshop update', dayOneStatus: 'Opening Day + Training Days 1-7 completed', dayOneTitle: 'Eight workshop events are now complete',
      dayOneText: 'Training Day 7 on 19 August focused on molecular dynamics foundations and hands-on system preparation, including force fields, simulation time steps, GROMACS workflows, and CHARMM-GUI preparation for protein-ligand simulations.',
      attendanceButton: 'Record your attendance', browseOpeningMaterials: 'Browse Training Day 7 materials', downloadFullProgram: 'Download full workshop program', downloadDayOneProgram: 'Download full workshop program', programPdfPending: 'The full workshop program will appear here when the file is uploaded.',
      dayOneGalleryEyebrow: 'Workshop activity highlights', dayOneGalleryTitle: 'Explore photographs by workshop day',
      dayOneGalleryText: 'Choose the Opening Day or Training Days 1-7. Six photographs are displayed at a time and automatically reshuffle every 10 seconds.',
      shuffleStatus: 'Showing 6 photos · reshuffles every 10 seconds', shuffleNow: 'Shuffle now', galleryOpeningTab: 'Opening Day', galleryTrainingDayOneTab: 'Training Day 1 · 5 Aug', galleryTrainingDayTwoTab: 'Training Day 2 · 8 Aug', galleryTrainingDayThreeTab: 'Training Day 3 · 10 Aug', galleryTrainingDayFourTab: 'Training Day 4 · 12 Aug', galleryTrainingDayFiveTab: 'Training Day 5 · 15 Aug', galleryTrainingDaySixTab: 'Training Day 6 · 17 Aug', galleryTrainingDaySevenTab: 'Training Day 7 · 19 Aug',
      ...
      completedLabel: 'Completed', firstDay: 'Opening Day + Training Days 1-7', attendanceFor: 'Attendance for', dayOne: 'Opening Day', formType: 'Form', presenceRecord: 'Presence record',
      ...
      scheduleEyebrow: 'Schedule at a glance', scheduleTitle: 'Three focused days every week', scheduleText: 'The Opening Day and Training Days 1-7 are complete. The remaining sessions continue through August 2026 on Saturday, Monday, and Wednesday from 10:00 to 15:00.',
      ...
      start: 'Start', august2026: 'August 2026', startsAugust: 'Workshop underway · 8 events completed', duration: 'Duration', oneMonth: 'One month', frequency: 'Frequency', threeDays: 'Three days per week', training: 'Training', lecturesPractical: 'Lectures and practical sessions',
      ...
      materialsEyebrow: 'Workshop learning library', materialsTitle: 'Training materials - latest session first', materialsText: 'Training Day 7 is selected by default. Open the molecular dynamics lecture, CHARMM-GUI preparation guide, shared Drive folder, GROMACS and CHARMM-GUI websites, Colab notebooks, and practical archive here; older sessions remain organized by day.',
      materialsChooseDay: 'Choose a day', materialsFutureReady: 'Day 7 materials are ready', materialsFutureText: 'The latest molecular dynamics and GROMACS resources are placed first for quick participant access, while all previous workshop materials remain available.',
      lectureTitle: 'Lecture title', openPoster: 'Open full poster', viewDetails: 'View details', poster: 'Poster', email: 'Email'
    },
    ar: {
      announcement: 'أُغلق التسجيل، واكتمل اليوم الافتتاحي والأيام التدريبية من الأول إلى السابع — وأصبحت مواد وروابط وصور اليوم السابع الخاصة بالديناميكا الجزيئية متاحة الآن.',
      ...
      heroLead: 'تستمر ورشة الفيزياء الحيوية الحاسوبية بعد اكتمال اليوم الافتتاحي والأيام التدريبية من الأول إلى السابع. ركز اليوم التدريبي السابع في 19 أغسطس على أساسيات الديناميكا الجزيئية وحقول القوة والخطوات الزمنية وإعداد GROMACS وتجهيز الأنظمة باستخدام CHARMM-GUI، وأصبحت مواده التعليمية والعملية متاحة الآن.',
      secureSeat: 'سجّل حضورك', exploreProgram: 'افتح مواد اليوم السابع', month: 'فعاليات مكتملة', daysWeek: 'أيام أسبوعيًا', coreModules: 'وحدة بالبرنامج', presenters: 'محاضرًا',
      ...
      videoText: 'شاهد هذا الفيديو التعريفي القصير للتعرف على هوية الورشة ونطاقها العلمي وتجربة التدريب العملي. اكتمل اليوم التدريبي السابع الآن.',
      ...
      dayOneEyebrow: 'تحديث الورشة', dayOneStatus: 'اكتمل اليوم الافتتاحي والأيام التدريبية 1-7', dayOneTitle: 'اكتملت ثماني فعاليات من الورشة',
      dayOneText: 'ركز اليوم التدريبي السابع في 19 أغسطس على أساسيات الديناميكا الجزيئية والإعداد العملي للأنظمة، بما يشمل حقول القوة والخطوات الزمنية وسير عمل GROMACS وإعداد الأنظمة باستخدام CHARMM-GUI.',
      attendanceButton: 'تسجيل الحضور', browseOpeningMaterials: 'تصفح مواد اليوم التدريبي السابع', downloadFullProgram: 'تحميل البرنامج الكامل للورشة', downloadDayOneProgram: 'تحميل البرنامج الكامل للورشة', programPdfPending: 'سيظهر البرنامج الكامل للورشة هنا بعد رفعه.',
      dayOneGalleryEyebrow: 'أبرز لحظات الورشة', dayOneGalleryTitle: 'استعرض الصور حسب يوم الورشة',
      dayOneGalleryText: 'اختر اليوم الافتتاحي أو أحد الأيام التدريبية من الأول إلى السابع. تُعرض ست صور في كل مرة ويُعاد ترتيبها تلقائيًا كل 10 ثوانٍ.',
      shuffleStatus: 'عرض 6 صور · إعادة ترتيب كل 10 ثوانٍ', shuffleNow: 'إعادة الترتيب الآن', galleryOpeningTab: 'اليوم الافتتاحي', galleryTrainingDayOneTab: 'اليوم التدريبي الأول · 5 أغسطس', galleryTrainingDayTwoTab: 'اليوم التدريبي الثاني · 8 أغسطس', galleryTrainingDayThreeTab: 'اليوم التدريبي الثالث · 10 أغسطس', galleryTrainingDayFourTab: 'اليوم التدريبي الرابع · 12 أغسطس', galleryTrainingDayFiveTab: 'اليوم التدريبي الخامس · 15 أغسطس', galleryTrainingDaySixTab: 'اليوم التدريبي السادس · 17 أغسطس', galleryTrainingDaySevenTab: 'اليوم التدريبي السابع · 19 أغسطس',
      registrationStatusLabel: 'التسجيل', registrationClosed: 'مغلق', workshopStatusLabel: 'حالة الورشة', inProgress: 'مستمرة',
      completedLabel: 'تم الانتهاء من', firstDay: 'اليوم الافتتاحي + الأيام التدريبية 1-7', attendanceFor: 'الحضور', dayOne: 'اليوم الافتتاحي', formType: 'النموذج', presenceRecord: 'تسجيل الحضور',
      ...
      scheduleEyebrow: 'نظرة سريعة على المواعيد', scheduleTitle: 'ثلاثة أيام مكثفة كل أسبوع', scheduleText: 'اكتمل اليوم الافتتاحي والأيام التدريبية 1-7، وتستمر الجلسات المتبقية خلال أغسطس 2026 أيام السبت والاثنين والأربعاء من الساعة 10:00 إلى 15:00.',
      ...
      start: 'موعد البدء', august2026: 'أغسطس 2026', startsAugust: 'الورشة مستمرة · اكتملت ثماني فعاليات', duration: 'المدة', oneMonth: 'شهر واحد', frequency: 'المواعيد', threeDays: 'ثلاثة أيام أسبوعيًا', training: 'نوع التدريب', lecturesPractical: 'محاضرات وجلسات عملية',
      ...
      materialsEyebrow: 'مكتبة مواد الورشة', materialsTitle: 'مواد التدريب - أحدث جلسة أولًا', materialsText: 'يُفتح اليوم التدريبي السابع افتراضيًا. يمكنك الوصول إلى محاضرة الديناميكا الجزيئية ودليل CHARMM-GUI ومجلد Drive وموقعي GROMACS وCHARMM-GUI ودفاتر Colab والأرشيف العملي، مع بقاء مواد الأيام السابقة منظمة حسب اليوم.',
      materialsChooseDay: 'اختر يومًا', materialsFutureReady: 'مواد اليوم السابع جاهزة', materialsFutureText: 'تظهر أحدث موارد الديناميكا الجزيئية وGROMACS أولًا لسهولة وصول المشاركين، مع استمرار إتاحة جميع مواد الأيام السابقة.',
  ...
  let selectedWorkshopGallery = 'day-7';
  ...
  function activeWorkshopGallery() {
    ...
    if (selectedWorkshopGallery === 'day-4') return Array.isArray(data.trainingDayFourGallery) ? data.trainingDayFourGallery : [];
    if (selectedWorkshopGallery === 'day-5') return Array.isArray(data.trainingDayFiveGallery) ? data.trainingDayFiveGallery : [];
    if (selectedWorkshopGallery === 'day-6') return Array.isArray(data.trainingDaySixGallery) ? data.trainingDaySixGallery : [];
    return Array.isArray(data.trainingDaySevenGallery) ? data.trainingDaySevenGallery : [];
  }
  ...
  function renderWorkshopGalleryTabs() {
    ...
    const items = [
      ...
      { id: 'day-5', label: tr('galleryTrainingDayFiveTab'), count: Array.isArray(data.trainingDayFiveGallery) ? data.trainingDayFiveGallery.length : 0 },
      { id: 'day-6', label: tr('galleryTrainingDaySixTab'), count: Array.isArray(data.trainingDaySixGallery) ? data.trainingDaySixGallery.length : 0 },
      { id: 'day-7', label: tr('galleryTrainingDaySevenTab'), count: Array.isArray(data.trainingDaySevenGallery) ? data.trainingDaySevenGallery.length : 0 }
    ];
