(() => {
  ...
  const translations = {
    en: {
      announcement: 'Registration is closed. The Opening Day and Training Days 1-6 are complete — Training Day 6 protein-protein docking materials and photos are now available.',
      ...
      heroLead: 'The Computational Biophysics Workshop is underway. The Opening Day and Training Days 1-6 are complete. Training Day 6 on 17 August covered protein-protein interactions, molecular recognition, docking interfaces, conformational changes, and HADDOCK, and its learning materials are now available.',
      secureSeat: 'Record your attendance', exploreProgram: 'Open Day 6 materials', month: 'Events complete', daysWeek: 'Days / week', coreModules: 'Program modules', presenters: 'Presenters',
      ...
      videoText: 'Watch this short introduction to the workshop identity, scientific scope, and hands-on learning experience. Training Day 6 is now complete.',
      ...
      dayOneEyebrow: 'Workshop update', dayOneStatus: 'Opening Day + Training Days 1-6 completed', dayOneTitle: 'Seven workshop events are now complete',
      dayOneText: 'Training Day 6 on 17 August focused on protein-protein docking, including molecular recognition, integrated structural biology, interaction interfaces, conformational changes upon association, and HADDOCK.',
      attendanceButton: 'Record your attendance', browseOpeningMaterials: 'Browse Training Day 6 materials', downloadFullProgram: 'Download full workshop program', downloadDayOneProgram: 'Download full workshop program', programPdfPending: 'The full workshop program will appear here when the file is uploaded.',
      dayOneGalleryEyebrow: 'Workshop activity highlights', dayOneGalleryTitle: 'Explore photographs by workshop day',
      dayOneGalleryText: 'Choose the Opening Day or Training Days 1-6. Six photographs are displayed at a time and automatically reshuffle every 10 seconds.',
      shuffleStatus: 'Showing 6 photos · reshuffles every 10 seconds', shuffleNow: 'Shuffle now', galleryOpeningTab: 'Opening Day', galleryTrainingDayOneTab: 'Training Day 1 · 5 Aug', galleryTrainingDayTwoTab: 'Training Day 2 · 8 Aug', galleryTrainingDayThreeTab: 'Training Day 3 · 10 Aug', galleryTrainingDayFourTab: 'Training Day 4 · 12 Aug', galleryTrainingDayFiveTab: 'Training Day 5 · 15 Aug', galleryTrainingDaySixTab: 'Training Day 6 · 17 Aug',
      ...
      completedLabel: 'Completed', firstDay: 'Opening Day + Training Days 1-6', attendanceFor: 'Attendance for', dayOne: 'Opening Day', formType: 'Form', presenceRecord: 'Presence record',
      ...
      scheduleEyebrow: 'Schedule at a glance', scheduleTitle: 'Three focused days every week', scheduleText: 'The Opening Day and Training Days 1-6 are complete. The remaining sessions continue through August 2026 on Saturday, Monday, and Wednesday from 10:00 to 15:00.',
      ...
      start: 'Start', august2026: 'August 2026', startsAugust: 'Workshop underway · 6 events completed', duration: 'Duration', oneMonth: 'One month', frequency: 'Frequency', threeDays: 'Three days per week', training: 'Training', lecturesPractical: 'Lectures and practical sessions',
      ...
      materialsEyebrow: 'Workshop learning library', materialsTitle: 'Training materials - latest session first', materialsText: 'Training Day 6 is selected by default. Open the shared Drive folder and the Protein-Protein Docking lecture PDF here; older sessions remain organized by day.',
      materialsChooseDay: 'Choose a day', materialsFutureReady: 'Day 6 materials are ready', materialsFutureText: 'The latest protein-protein docking resources are placed first for quick participant access, while all previous workshop materials remain available.',
      lectureTitle: 'Lecture title', openPoster: 'Open full poster', viewDetails: 'View details', poster: 'Poster', email: 'Email'
    },
    ar: {
      announcement: 'أُغلق التسجيل، واكتمل اليوم الافتتاحي والأيام التدريبية من الأول إلى السادس — وأصبحت مواد وصور اليوم السادس الخاصة بالالتحام البروتيني متاحة الآن.',
      ...
      heroLead: 'تستمر ورشة الفيزياء الحيوية الحاسوبية بعد اكتمال اليوم الافتتاحي والأيام التدريبية من الأول إلى الخامس. ركز اليوم التدريبي الخامس في 15 أغسطس على ميكانيكا الكم والكيمياء الحاسوبية وDFT وGaussian 09 وGaussView، وأصبحت مواده التعليمية متاحة الآن.',
      secureSeat: 'سجّل حضورك', exploreProgram: 'افتح مواد اليوم الخامس', month: 'فعاليات مكتملة', daysWeek: 'أيام أسبوعيًا', coreModules: 'وحدة بالبرنامج', presenters: 'محاضرًا',
      ...
      videoText: 'شاهد هذا الفيديو التعريفي القصير للتعرف على هوية الورشة ونطاقها العلمي وتجربة التدريب العملي. اكتمل اليوم التدريبي السادس الآن.',
      ...
      dayOneEyebrow: 'تحديث الورشة', dayOneStatus: 'اكتمل اليوم الافتتاحي والأيام التدريبية 1-6', dayOneTitle: 'اكتملت سبع فعاليات من الورشة',
      dayOneText: 'ركز اليوم التدريبي السادس في 17 أغسطس على الالتحام البروتيني، بما يشمل التعرف الجزيئي والبيولوجيا البنيوية التكاملية وواجهات التفاعل والتغيرات الشكلية عند الارتباط وHADDOCK.',
      attendanceButton: 'تسجيل الحضور', browseOpeningMaterials: 'تصفح مواد اليوم التدريبي السادس', downloadFullProgram: 'تحميل البرنامج الكامل للورشة', downloadDayOneProgram: 'تحميل البرنامج الكامل للورشة', programPdfPending: 'سيظهر البرنامج الكامل للورشة هنا بعد رفعه.',
      dayOneGalleryEyebrow: 'أبرز لحظات الورشة', dayOneGalleryTitle: 'استعرض الصور حسب يوم الورشة',
      dayOneGalleryText: 'اختر اليوم الافتتاحي أو أحد الأيام التدريبية من الأول إلى السادس. تُعرض ست صور في كل مرة ويُعاد ترتيبها تلقائيًا كل 10 ثوانٍ.',
      ...
      completedLabel: 'تم الانتهاء من', firstDay: 'اليوم الافتتاحي + الأيام التدريبية 1-6', attendanceFor: 'الحضور', dayOne: 'اليوم الافتتاحي', formType: 'النموذج', presenceRecord: 'تسجيل الحضور',
      ...
      scheduleEyebrow: 'نظرة سريعة على المواعيد', scheduleTitle: 'ثلاثة أيام مكثفة كل أسبوع', scheduleText: 'اكتمل اليوم الافتتاحي والأيام التدريبية 1-6، وتستمر الجلسات المتبقية خلال أغسطس 2026 أيام السبت والاثنين والأربعاء من الساعة 10:00 إلى 15:00.',
      ...
      start: 'موعد البدء', august2026: 'أغسطس 2026', startsAugust: 'الورشة مستمرة · اكتملت ست فعاليات', duration: 'المدة', oneMonth: 'شهر واحد', frequency: 'المواعيد', threeDays: 'ثلاثة أيام أسبوعيًا', training: 'نوع التدريب', lecturesPractical: 'محاضرات وجلسات عملية',
      ...
      materialsEyebrow: 'مكتبة مواد الورشة', materialsTitle: 'مواد التدريب - أحدث جلسة أولًا', materialsText: 'يُفتح اليوم التدريبي الخامس افتراضيًا. يمكنك الوصول مباشرة إلى مجلد Drive وملفات Gaussian 09 والكيمياء الحاسوبية وأساسيات الكيمياء الكمية، مع بقاء مواد الأيام السابقة منظمة حسب اليوم.',
      materialsChooseDay: 'اختر يومًا', materialsFutureReady: 'مواد اليوم السادس جاهزة', materialsFutureText: 'تظهر أحدث موارد الكيمياء الكمية وGaussian أولًا لسهولة وصول المشاركين، مع استمرار إتاحة جميع مواد الأيام السابقة.',
  ...
  let selectedWorkshopGallery = 'day-6';
  ...
  function activeWorkshopGallery() {
    ...
    return Array.isArray(data.trainingDaySixGallery) ? data.trainingDaySixGallery : [];
  }
